  ...
  ionViewDidLoad() {
    ...
    switch (this.getRandom()) {
      ...
      case 2: {
        ...
        this.speak(`
        유니가 드리는 코디점수는 별 두개!
        약간 호불호가 갈릴 것 같네요. 다른 옷을 입어보는 건 어떨까요? 유니가 드리는 별은 2개! 
      ...
      case 4: {
        ...
        this.speak(`
        유니가 드리는 코디점수는 별 네개!
        코디를 잘 하셨네요. 유니가 드리는 코디점수는 별 4개! 지금 입고 
      ...
      case 5: {
        ...
        this.speak(`
        유니가 드리는 코디점수는 별 다섯개!
        당신은 패션왕! 정말 코디를 잘하셨네요! 유니가 드리는 코디점수는 별 5개! 
