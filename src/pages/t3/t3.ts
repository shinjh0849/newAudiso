...
export class T3Page {
  ...
  ionViewDidLoad() {
    ...
    this.hamsoo('쇼핑 시작 전에, 간단한 어플사용방법을 알려드릴게요. 먼저 어플 내 서비스 이용을 위한 간단한 동작(제스쳐)을 알려드릴게요. 제가 말씀드리는 동작(제스처)을 화면에 그대로 따라해주세요.      첫번째 동작은 ‘탭 두번’ 이에요. 삐 소리가 들리면 화면에 탭 두번 해주세요. (띠링) ');
