...
export class P1_2Page {
  ...
  ionViewDidLoad() {
    this.hamsoo('안녕하세요? 고객님의 쇼핑친구가 되어드릴 유니입니다. 혹시 오늘 보고 싶은 옷이 있으신가요? 보고 싶은 옷의 가격대와 소재, 색상을 알려주시면 유니가 옷을 추천 해 드릴게요. 지금 특별히 보고 싶은 옷이 있으시면 탭 한 번을, 없으시면 탭 두 번을 눌러주세요.');
  }
